<template lang="html">
  <div>
    <p>Отчет {{ report_name }}</p>
   <input type="button" @click="exportCanvasAsPNG('chart', 'myImg', 'myImg2')" value="getPdf"></input>
   <input type="button" @click="postImage('chart')" value="postImage"></input>
   <input type="button" @click="RunExcelJSExport()" value="getExcel"></input>

   
   <a href='http://127.0.0.1:3001/excel'>excel</a>
 
   <table id="table">
     <tr><td>привет привет привет</td> <td>привет ривет привет привет </td> <td>привет</td> <td>привет</td> <td>привет</td> </tr>
    <tr><td>привет привет привет</td> <td> привет привет привет привет</td> <td>привет ривет привет привет</td> <td>привет</td> <td>привет</td></tr>
...
//         reportsList: [],
     ...
     methods: {
//       getReport(id){
//         let report = this.reportsList.filter(report => {return report.id == id});
//         if (report.length > 0)
//           this.report_name = report[0].name;
//         else this.report_name = "не найден"
...
//       api().
//         post('/imgBase64', {imgBase64: dataURL})
//         .then(response => {
                  
//               })
//         .catch(error => {
//                 alert('Ошибка при загрузке графика '+ error);
//               });
...
//   },
 ...
 exportCanvasAsPNG: function(id, idImg) {
    ...
    $domElement.height(svg.height())
    $domElement.width(svg.width())
...
//     //        var dataURL = canvasElement.toDataURL(MIME_TYPE);
//     //        img.src = dataURL;
//     //    }, 100);
//      }
...
//     },
//     created: function() {
//         this.reportsList.push({ id: '1', name: 'Каталог оборудования'});
//         this.reportsList.push({ id: '2', name: 'Использование оборудования'});
